...
export const FAQ_ENTRIES: FaqEntry[] = [
  ...
  },
  {
    ...
    roles: ['property_owner'],
    answer: 'Partner Rewards lets you refer another landlord. When they complete their first owner login via your link, you earn 15% billing credit toward renewal (max 45%). Tap Rewards in the header or Discover strip, or open Plans & Billing.',
